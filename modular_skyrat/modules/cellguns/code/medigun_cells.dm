...
/obj/projectile/energy/medical/proc/IsLivingHuman(atom/target, blocked = FALSE, pierce_hit)
...
/obj/projectile/energy/medical/proc/checkReagents(atom/target, blocked = FALSE, pierce_hit)
...
/obj/projectile/energy/medical/brute/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/energy/medical/burn/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/energy/medical/toxin/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/energy/medical/safe/brute/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/energy/medical/safe/burn/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/energy/medical/upgraded/toxin3/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
	healTox(target, 10)
...
/obj/projectile/energy/medical/utility/clotting/on_hit(atom/target, blocked = FALSE, pierce_hit)
	if(!IsLivingHuman(target))
		return FALSE
...
/obj/projectile/energy/medical/utility/gown/on_hit(atom/target, blocked = FALSE, pierce_hit)
...
/obj/projectile/energy/medical/utility/salve/on_hit(atom/target, blocked = FALSE, pierce_hit)
...
/obj/projectile/energy/medical/utility/bed/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
...
/obj/projectile/energy/medical/utility/relocation/on_hit(atom/target, blocked = FALSE, pierce_hit)
	. = ..()
