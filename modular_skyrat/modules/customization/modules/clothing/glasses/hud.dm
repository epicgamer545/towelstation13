...
/obj/item/clothing/glasses/hud/eyepatch/diagnostic
	...
	desc = "Lost your eyeball to a rogue borg? Got bored? Whatever the reason, this bit of tech will help you still repair borgs, they'll never need it since they usually do it themselves, but its the thought that counts."
